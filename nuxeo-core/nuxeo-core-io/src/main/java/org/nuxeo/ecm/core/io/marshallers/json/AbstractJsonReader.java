...
public abstract class AbstractJsonReader<EntityType> implements Reader<EntityType> {
    ...
    /**
     * Try to get a boolean property of the given {@link JsonNode}. Return null if the node is null or not a boolean.
     * @param jn The {@link JsonNode} to parse.
     * @param elName The property name.
     * @return The boolean value if it exists and is a boolean property, null otherwise.
     *
     * @since 9.2
     */
    ...
    /**
     * Try to get a string list property of the given {@link JsonNode}. Return null if the node is null or not a
     * string list.
     * @param jn The {@link JsonNode} to parse.
     * @param elName The property name.
     * @return A string list if it exists and is a valid string list property, null otherwise.
     *
     * @since 9.2
     */
